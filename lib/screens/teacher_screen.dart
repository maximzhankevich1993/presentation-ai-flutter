...
class _TeacherScreenState extends State<TeacherScreen> {
  ...
  void _selectTariff(String tariff) {
    ...
    switch (tariff) {
      case 'teacher':
        message = 'Бесплатный тариф "Учитель" активирован';
        break;
      case 'school':
        message = 'Вы выбрали тариф "Школа"';
        break;
      case 'university':
        message = 'Вы выбрали тариф "Университет"';
        break;
    }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Напишите нам на почту для\nподбора образовательного тарифа',
                style: TextStyle(
                  color: Color(0xFF9A9A9A),
                  fontSize: 13,
                ),
