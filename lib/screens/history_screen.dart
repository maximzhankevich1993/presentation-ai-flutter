    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content:
              Text('Презентация "${p.title}" будет удалена.'),
          actions: [
            TextButton(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content:
                        const Text('Презентация удалена'),
