...
class _LoadingScreenState extends State<LoadingScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _generatePresentation() async {
    try {
      ...
      _slidesGenerated = response['slides']?.length ?? 0;
      ...
      if (mounted) {
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) => EditorScreen(presentation: response)));
      }
    } catch (e) {
            ...
            AnimatedBuilder(
              ...
              child: Container(
                ...
                child: Stack(alignment: Alignment.center, children: [
                  ...
                  if (_error == null)
                    Positioned(top: 16, right: 24, child: Text('💡', style: TextStyle(fontSize: 32.sp))),
                ]),
              ),
            ),
