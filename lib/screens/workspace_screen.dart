      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            ...WorkspaceService.getTeamMembers().map((user) => Container(
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    ...
                    radius: 24.r,
                    child: Text(user.name[0], style: TextStyle(color: Colors.white, fontSize: 18.sp, fontWeight: FontWeight.bold)),
                  ),
                  SizedBox(width: 16.w),
                  Expanded(
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.insert_drive_file, color: Color(0xFF4F46E5)),
                  ),
                  SizedBox(width: 16.w),
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            if (!userProvider.isPremium) ...[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(colors: [const Color(0xFFF59E0B).withOpacity(0.1), const Color(0xFFD97706).withOpacity(0.05)]),
                  borderRadius: BorderRadius.circular(16),
        ...
        content: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(inviteLink, style: TextStyle(fontSize: 12.sp)),
            ),
          ],
        ),
        actions: [
